...
function cube2uni(str) {
  ...
  for (var i = 0; i < str.length; i++) {
    res += String.fromCharCode(cube2unichars[str[i].charCodeAt()]);
  }return res;
}
...
var Packet = exports.Packet = function () {
  /**
   *  @constructor
